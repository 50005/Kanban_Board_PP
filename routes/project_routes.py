...
def create_project():
    ...
    created_project = project_service.create_project(title=project.title, description=project.description)  # Добавлено поле description
...
def update_project(project_id: int):
    ...
    db: Session = next(get_db())
    project_service = ProjectService(db)
    updated_project = project_service.update_project(project_id=project_id, title=project.title, description=project.description)  # Добавлено поле description
